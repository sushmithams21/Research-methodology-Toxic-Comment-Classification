...
train_new.to_csv("toxic_nontoxic/Train_dataAugmented_LSTM.csv" , index=False)

train_data = pd.read_csv("toxic_nontoxic/Train_dataAugmented_LSTM.csv")
...
print("--------LSTM with Data Augmentation------------------------------")
